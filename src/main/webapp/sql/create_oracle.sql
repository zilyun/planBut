...
CREATE TABLE board(
    ...
    regdt date DEFAULT sysdate NOT NULL,    --	regdt datetime DEFAULT now() NOT NULL,
...
CREATE TABLE calendar(
	...
	ct_code char(2) NOT NULL,
	memo varchar(100),
    c_date date NOT NULL,    --	date datetime NOT NULL,
...
CREATE TABLE courseplan(
    ...
    cos_date date NOT NULL,    --	date datetime NOT NULL,
	FOREIGN KEY(cp_code) REFERENCES cityplan(cp_code)
);
