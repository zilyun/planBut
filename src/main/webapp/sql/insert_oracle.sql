...
VALUES('CP001', 'P001', 'PR', 1, 3, '기차', sysdate, 'Y');

-- 캘린더-------------------------------------------
INSERT INTO calendar(cal_code, cp_code, ct_code, memo, c_date)
VALUES('CAL001', 'CP001', 'PR', '메모입니다', sysdate);

-- 경로계획-------------------------------------------
INSERT INTO courseplan(cos_code, cp_code, course, cos_date)
VALUES('RT001', 'CP001', '111,110,101,100', sysdate);
...
VALUES('TIC001', 'CP001', '박물관티켓', sysdate, 5000, '메에모');

-- 투어-------------------------------------------
INSERT INTO mytour(tr_code, ct_code, tr_name, mt_date, price, memo)
VALUES('TR001', 'CP001', '베르사유투어', sysdate, 5000, '메에모');
...
VALUES('A20190403-1', 'CP001', 'aaaa', 'bbbb', sysdate, '0');
...
VALUES('TU001', '베르사유투어', 'PR', 50000, '베르사유투어설명', sysdate, sysdate, 'pic.jpg', '1', 4, '파리 북역', 2, 7, '0,2,3,4,5,6');

-- 장바구니 -------------------------------------------
INSERT INTO cart(cart_code, tour_code, m_id, people, tourday)
VALUES('20190410-12', 'TU001', 'aaaa', 2, sysdate);

-- 투어예약 -------------------------------------------
INSERT INTO treserve(re_code, tour_code, m_id, pay_type, ts_date, payed, people)
VALUES('20190317-12', 'TU001', 'aaaa', 2, sysdate, 60000, 1);

-- 투어문의 -------------------------------------------
INSERT INTO tqna(tq_code, tour_code, m_id, content, regdt)
VALUES('Q001', 'TU001', 'aaaa', '문의내용', sysdate);

-- 투어문의답변 -------------------------------------------
INSERT INTO treply(tq_code, reply_code, content, regdt)
VALUES('Q001', 'Q001-01', '답변내용이요', sysdate);

-- 투어리뷰 -------------------------------------------
INSERT INTO treview(rv_code, re_code, m_id, content, star, regdt)
VALUES('RE001', '20190317-11', 'aaaa', '리뷰입니다', 4, sysdate);
